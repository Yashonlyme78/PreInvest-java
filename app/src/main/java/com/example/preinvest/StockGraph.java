...
public class StockGraph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lineChart = findViewById(R.id.activity_stock_graph_linechart);

        stockTickerTextInputLayout = findViewById(R.id.activity_stock_graph_stockticker);
        periodRadioGroup = findViewById(R.id.activity_stock_graph_period_radiogroup);
        intervalRadioGroup = findViewById(R.id.activity_stock_graph_priceinterval);

        highCheckBox = findViewById(R.id.activity_stock_graph_high);
        lowCheckBox = findViewById(R.id.activity_stock_graph_low);
        closeCheckBox = findViewById(R.id.activity_stock_graph_close);

        configureLineChart();
        setupApi();
        findViewById(R.id.activity_stock_graph_getprices).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void getStockData() {
        ...
        switch (periodRadioGroup.getCheckedRadioButtonId()) {
            case R.id.activity_stock_graph_period1d:
                startTime = endTime - (60 * 60 * 24);
                break;
            case R.id.activity_stock_graph_period30d:
                startTime = endTime - (60 * 60 * 24 * 30);
                break;
            case R.id.activity_stock_graph_period90d:
                startTime = endTime - (60 * 60 * 24 * 90);
                break;
            case R.id.activity_stock_graph_period12m:
        ...
        switch (intervalRadioGroup.getCheckedRadioButtonId()) {
            case R.id.activity_stock_graph_interval1d:
                frequency = "1d";
                break;
            case R.id.activity_stock_graph_interval1w:
                frequency = "1w";
                break;
            case R.id.activity_stock_graph_interval1m:
                frequency = "1m";
                break;
        }
